...
published: true
media_subpath: https://lab.plant-humanities.org/assets/posts/black-eyed-pea
image:
  path: banner.jpg
storykit: true
...
{% include embed/image.html src="wc:Field_of_Vigna_unguiculata.jpg" aspect="1.33" %}
{% include embed/image.html src="wc:Vigna_unguiculata_nodules1_(10737516253).jpg" aspect="1.33" %}
...
{% include embed/image.html src="wc:Restes_du_banquet,_mosaïque.jpg" caption="Sosus of Pergamon, after, Banquet leftovers, or Unswept Floor, early 2nd CE, mosaic, 4.05 x 0.41 m, Museum Gregoriano Profano, Vatican." aspect="1.47" %}
...
{% include embed/image.html src="Yardlong_bean.jpg" caption="Cowpea [Vigna unguiculata (L.) Walp.], Seikei Zuetsu, vol. 18, Leiden University Library." aspect="0.65" %}
...
{% include embed/image.html src="slaveryinunit00ballcha_0172.jpg" aspect="0.59" %}
...
{% include embed/image.html src="master-mss-mgw-mgw2-014-2340228.jpg" aspect="0.59" %}
...
{% include embed/image.html src="wartimesketcheshdimi_0075.jpg" aspect="0.59" %}
...
{% include embed/image.html src="CAT31355486_0003.jpg" aspect="0.59" %}
...
{% include embed/image.html src="wc:Imperial_Federation_Map_of_the_World.jpg" aspect="1.35" %}
...
{% include embed/youtube.html vid="R6l8jRF-eGA" caption="A feast of African-American culinary contributions, baked into the South’s DNA" aspect="1.55" %}
...
{% include embed/youtube.html vid="v7HwKxDus9E" caption="Tiebou yapp niébé" aspect="1.55" %}
...
{% include embed/image.html src="wc:Hoppin%27_John_at_Brenda%27s_Meat_%26_Three_for_good_luck._San_Francisco,_CA._(39570682392).jpg" aspect="1.33" %}
{% include embed/image.html src="wc:Hoppin_John.jpg" rotation="90" aspect="0.75" %}
{% include embed/image.html src="wc:Hoppin'_John.jpg" aspect="1.49" %}
...
{% include embed/image.html src="wc:فيجوادا_feijoada.jpg" caption="Feijoada with rice, fried kale, cassava starch crisps (biscoito de polvilho), cassava flour (farinha), and a mix of olive oil, alcohol vinegar, tomatoes, onions and sometimes bell peppers called vinagrete." aspect="0.75" %}
{% include embed/image.html src="wc:Feijoada_à_brasileira_-02.jpg" caption="Feijoada à brasileira." aspect="1.17" %}
{% include embed/image.html src="wc:Soul_Food_Deli_Shreveport.jpg" caption="P & C Soul Food Deli, Shreveport, Louisiana." aspect="1.50" %}
...
{% include embed/map.html center="25.19559,17.57813" zoom="1" caption="Map of black-eyed pea distribution showing native range (blue) and introduction (green) (after Kew’s Plants of the World Online)." geojson="Distribution_5.geojson~Distribution" %}
...
{% include embed/image-compare.html before="wc:Drying_cowpeas.jpg" after="wc:Wild_and_cultivated_cowpea_%287856427546%29.jpg" aspect="1.5" class="right" %}
...
{% include embed/youtube.html vid="pqmBsUHSkBg" caption="Beyond the gardens, the crop wild relatives project" aspect="1.55" %}
